                        ...
                        <form class="form-label-left input_mask" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-6 col-sm-6  form-group has-feedback">
                                <input type="text" class="form-control" id="pro_name" name="pro_name"
                                    placeholder="Tên Sản phẩm" value="{{$product->pro_name}}">
                            </div>
                            <div class="col-md-6 col-sm-6  form-group has-feedback">
                                <select class="form-control" id="cat_id" name="cat_id">
                                    <option value="">-- Select Category --</option>
                                    <?php showCategories($categories,$product) ?>
                                </select>
                            </div>
                            <div class="col-md-6 col-sm-6  form-group has-feedback">
                            ...
                            <div class="col-md-6 col-sm-6  form-group has-feedback">
                                <input type="text" class="form-control" id="saleprice" name="saleprice"
                                    placeholder="Nhập giá khuyến mãi" value="{{$product->saleprice}}">
                            </div>
...
function showCategories($categories,$product,$parent_id=0,$char=''){
    ...
    {
        $selected=$product->cat_id==$item->id ? 'selected' : '';
