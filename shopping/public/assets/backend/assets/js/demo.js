...
$(document).ready(function() {
    ...
    $('#slider-range-value1z').val(20000);
    $('#slider-range-value2z').val(100000);
    ...
    rangeSlider.noUiSlider.on('update', function(values, handle) {
      document.getElementById('slider-range-value1z').value = moneyFormat.from(
        values[0]);
      document.getElementById('slider-range-value2z').value = moneyFormat.from(
        values[1]);
